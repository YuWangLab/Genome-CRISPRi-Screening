#!/bin/bash
#SBATCH --output=/hpcfs/fhome/sunlet/dual/job.%j.out  # Directs the output of the job to a specific file, using job ID
#SBATCH --error=/hpcfs/fhome/sunlet/dual/job.%j.err   # Directs the error output of the job to a specific file, using job ID
...
mkdir -p /hpcfs/fhome/sunlet/dual                                      # Creates the directory if it doesn't exist
cd /hpcfs/fhome/sunlet/dual                                            # Changes the working directory to the specified path
